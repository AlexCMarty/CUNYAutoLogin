...
src/
  ...
  onboarding/state.ts           24-state enum, bead mapping, resume policy
  ...
  onboarding/screens/           welcome, emailEntry, passwordEntry, cunyTotp, openingCuny, allowGate,
                                ...
                                Credential-error UX is not a separate state: the inline red-banner view
...
Minimum versions: Firefox **140+**, Chromium **141+** (`src/manifest.json`).
