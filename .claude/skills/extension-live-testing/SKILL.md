...
Discover the exact tool names and arguments for the `chrome-extension-tester` MCP server via your environment’s tool-search / MCP mechanism, then call them.
