...
**Privacy:** Your email, password, and authenticator secret are **encrypted** on your computer. You choose an **extension password** that unlocks the vault. You can also log in with biometrics like your face or fingerprint. 
...
2. Download the **zip** for the version you want (for example `CUNYAutoLogin-v0.6.0.zip`).
...
6. **Optional: biometrics** — if your device supports it, you may be offered **Face ID / fingerprint** to unlock the sidebar instead of typing the extension password each time (you can skip this).
